...
export class Game{
 ...
 update(dt){
  ...
  if(physics.landed){p.land=.12;p.anim='land';p.animTimer=.16;this.triggerFeedback('land',1);this.audio.land();this.particles.burst(this.playerModel.position,0xffffff,7,2.6);this.follow.kick(.035)}
