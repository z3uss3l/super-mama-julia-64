export class UI{
 ...
 style(){
  const s=document.createElement('style');s.textContent=`*{box-sizing:border-box}html,body,#app,#game{margin:0;width:100%;height:100%;overflow:hidden;background:#05070d;color:#fff;font-family:system-ui,sans-serif}#game{position:relative}canvas{position:absolute;inset:0;width:100%;height:100%}#hud{position:absolute;inset:0;pointer-events:none;text-shadow:2px 2px 4px #000}.bar{display:flex;justify-content:space-between;padding:12px;gap:8px}.bar span,#objective,#abilities,#combo{background:#070b12bb;border:1px solid #fff3;border-radius:10px;padding:7px 10px;font-weight:900}.bar span{font-size:13px}#objective{position:absolute;top:58px;left:12px}#abilities{position:absolute;top:58px;right:12px}.ability{display:inline-block;margin-left:7px}.ready{color:#9cffb0}.locked{opacity:.3;filter:grayscale(1)}#combo{position:absolute;top:105px;left:50%;transform:translateX(-50%);color:#ffd43b;opacity:0;transition:.15s}#combo.show{opacity:1}#boss{display:none;position:absolute;top:12px;left:50%;transform:translateX(-50%);width:min(360px,55vw);text-align:center}#boss div{height:13px;background:#171b26;border:1px solid #fff;border-radius:8px;overflow:hidden}#bossFill{display:block;height:100%;width:100%;background:#ff4d4d}#toast{position:absolute;left:50%;top:48%;transform:translate(-50%,-50%) scale(.96);background:#090c16ee;border:2px solid #ffd43b;padding:14px 20px;border-radius:12px;color:#ffe47b;font-weight:900;opacity:0;transition:.18s;white-space:nowrap}.screen{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;text-align:center;background:#050812c9;backdrop-filter:blur(5px)}.screen section{width:min(760px,92%);padding:34px;background:#070b14ee;border:1px solid #fff2;border-radius:22px;box-shadow:0 25px 100px #000}.eyebrow{font-weight:900;letter-spacing:.2em;color:#ffd43b}.screen h1{font-size:clamp(44px,8vw,82px);line-height:.9;margin:8px 0;color:#ffd43b}.screen p{white-space:pre-line;color:#d8dbea;line-height:1.55}.buttons{display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-top:24px}.buttons button,#touch button{border:1px solid #fff4;background:#111827;color:#fff;border-radius:11px;padding:12px 18px;font-weight:900}.buttons button:first-child{background:#7d4b00;border-color:#ffd43b}small{display:block;margin-top:18px;color:#aab1c5}.screen .buttons{pointer-events:auto}#touch{position:fixed;bottom:10px;left:50%;transform:translateX(-50%);width:min(1100px,100%);display:flex;justify-content:space-between;padding:0 12px;pointer-events:none}#touch>div{display:flex;gap:8px;pointer-events:auto}#touch button{width:54px;height:54px;padding:0;border-radius:50%;font-size:20px;background:#08101acc;touch-action:none}@media(max-width:600px){#abilities{top:105px}#objective{top:105px;max-width:50vw}.screen section{padding:24px}.bar span{font-size:11px}}`;document.head.appendChild(s)
 }
 ...
 showScreen(title,text,sub=''){this.q('#screen').style.display='flex';this.q('#screenTitle').textContent=title;this.q('#screenSub').textContent=sub;this.q('#screenText').textContent=text}
