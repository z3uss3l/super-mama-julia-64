export const GAME={name:'Super Mama Julia 64',version:'4.1.0',saveKey:'smj64-v4',gravity:-25,playerSpeed:8,jumpSpeed:10,dashSpeed:19,maxLives:5,checkpointRatio:.48,comboWindow:2.5};
export const WORLDS=[
